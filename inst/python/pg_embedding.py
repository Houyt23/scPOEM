...
def metapath2vec_pg(gg_net, pp_net, pg_net_list, dirpath, d=100, numwalks=5, walklength=3, epochs=100, neg_sample=5, batch_size=32, weighted = True, exclude_pos=False, seed=0):
